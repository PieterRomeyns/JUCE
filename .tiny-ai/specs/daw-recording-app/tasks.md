...
- [x] **Task 5.3 — Project model and serialiser**
...
- [x] **Task 7.1 — Connect MixerEngine to AudioEngine callback**
...
- [x] **Task 7.2 — Connect TrackProcessor to audio file playback**
...
- [x] **Task 7.3 — Connect MIDI tracks to instruments**
...
- [x] **Task 8.7 — EffectRackView and EffectEditorView**
